    ...
    public abstract partial class SmokeSegment : Drawable, ITexturedShaderDrawable
    {
        ...
        protected class SmokeDrawNode : TexturedShaderDrawNode
        {
            ...
            protected virtual Colour4 PointColour(SmokePoint point)
            {
                ...
                {
                    float fraction = float.Clamp((float)(timeDoingFinalFadeOut / final_fade_out_duration), 0, 1);
                ...
                else
                {
                    ...
                    {
                        float fraction = float.Clamp((float)(timeDoingInitialFadeOut / initial_fade_out_duration), 0, 1);
                    ...
                    if (point.Time > firstVisiblePointTimeAfterSmokeEnded)
                    {
                        ...
                        {
                            float fraction = float.Clamp((float)(timeDoingReFadeIn / re_fade_in_duration), 0, 1);
            ...
            protected virtual float PointScale(SmokePoint point)
            {
                ...
                float fraction = float.Clamp((float)(timeDoingScale / scale_duration), 0, 1);
                fraction = 1 - MathF.Pow(1 - fraction, 5);
            ...
            protected virtual Vector2 PointDirection(SmokePoint point, int index)
            {
                ...
                float fraction = float.Clamp((float)(timeDoingRotation / rotation_duration), 0, 1);
                fraction = 1 - MathF.Pow(1 - fraction, 5);
