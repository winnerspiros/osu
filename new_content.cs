...
namespace osu.Framework.Android
{
    ...
    public abstract class AndroidGameActivity : SDLActivity
    {
        ...
        // JNI activation constructor: called by TypeManager.Activate when Android's Java runtime
        // creates this Activity and needs to wrap it in a managed peer.  Without this constructor,
        // TypeManager.Activate throws NotSupportedException for any class that inherits from
        // AndroidGameActivity (e.g. OsuGameActivity in the osu! repo).
        // SDLActivity (in SDL3-CS) declares the matching (IntPtr, JniHandleOwnership) constructor,
        // so the base() call is valid.
        protected AndroidGameActivity(IntPtr javaReference, JniHandleOwnership transfer)
